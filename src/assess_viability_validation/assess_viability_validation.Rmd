...
ggplot(temp %>% filter(drug %in% c("Masitinib", "Ripasudil", "AT-13148")), 
...
ggplot(temp %>% filter(drug %in% c("RGB-286638", "PHA-793887")), 
			 aes(x=log10(concentration_M), y=actual_viability, color=cell_line)) +
	geom_hline(aes(yintercept = 90), linetype = 2) +
	geom_point() +
	geom_smooth() +
...
ggplot(temp %>% filter(drug %in% c("AT-9283", "Lestaurtinib")), 
			 aes(x=log10(concentration_M), y=actual_viability, color=cell_line)) +
	geom_hline(aes(yintercept = 90), linetype = 2) +
	geom_point() +
	geom_smooth() +
...
ggplot(temp %>% filter(drug %in% c("K-252a", "PF-03814735", "XL-228")), 
			 aes(x=log10(concentration_M), y=actual_viability, color=cell_line)) +
	geom_hline(aes(yintercept = 90), linetype = 2) +
	geom_point() +
	geom_smooth() +
