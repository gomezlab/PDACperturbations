...
klaeger_full = klaeger_full %>%
	...
	write_rds(here('results/klaeger_full_tidy.rds'))
```
...
Considering all the possible drug/gene target combinations in the Klaeger data, only `r percent_present`% are present in the data set. The distribution of the number of listed gene hits per compound is:
